//contains the main game functions, and keeps track of active game, determines winner or tie game status
...
function game(username1, username2){
    ...
    //board grid size (used to determine winner based on X (1) and O (-1) value)
    this.boardSize = 3;
...
// draws the current board after each move
        ...
        //move only occurs for activePlayer
            ...
            if(currentGame.activePlayer == payload.user_name){
                ...
                if(currentGame.username1 == payload.user_name || currentGame.username2 == payload.user_name){
                        ...
                        return 'Hey! it\'s' + currentGame.activePlayer +
                            '\'s chance to take a turn. wait for your turn ;)' +
...
// ======= winning/tie recognition status functions =======
...
// switch cases, if winner or tie is recognized, finished = true
