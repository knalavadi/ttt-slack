//authenticates slack token, and checks oppponent in slack chanel before beginning game. 
//functions follow the slack api methods: https://api.slack.com/methods using slack npm
